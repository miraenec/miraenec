...
I build mobile and web products with a focus on practical execution, scalable architecture, and business impact.

* Mobile app development across **iOS**, **Android**, and **cross-platform frameworks**
* Frontend development with **React**, **Vue**, and modern JavaScript ecosystems
* Backend/API development with **Node.js** and **PHP**
* Product-oriented engineering for real-world services and business operations
...
<p>
  ...
  <img src="https://img.shields.io/badge/ExtJS-86BC40?style=flat-square&logo=sencha&logoColor=white" alt="ExtJS"/>
...
* Product planning and service operation
